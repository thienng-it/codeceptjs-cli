            ...
            const result = await p.group(
                {
                    ...
                    plugins: () =>
                        p.multiselect({
                            ...
                            options: [
                                { hint: 'capture screenshots on failure', label: 'screenshotOnFail', value: 'screenshotOnFail' },
                                { hint: 'auto-retry failed steps', label: 'retryFailedStep', value: 'retryFailedStep' },
